...
vectorized_functions = [
    ...
    [38170, 'trim', True, False, 'GERMAN_STRING', ['GERMAN_STRING'], 'StringFunctions::trim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38171, 'trim', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::trim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38180, 'ltrim', True, False, 'GERMAN_STRING', ['GERMAN_STRING'], 'StringFunctions::ltrim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38181, 'ltrim', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::ltrim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38190, 'rtrim', True, False, 'GERMAN_STRING', ['GERMAN_STRING'], 'StringFunctions::rtrim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38191, 'rtrim', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::rtrim_german_string',
     'StringFunctions::trim_prepare', 'StringFunctions::trim_close'],
    [38200, 'lpad', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'INT', 'GERMAN_STRING'],
     'StringFunctions::lpad_german_string',
     'StringFunctions::pad_prepare', 'StringFunctions::pad_close'],
    [38210, 'rpad', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'INT', 'GERMAN_STRING'],
     'StringFunctions::rpad_german_string',
     'StringFunctions::pad_prepare', 'StringFunctions::pad_close'],
    [38220, 'replace', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::replace_german_string',
     'StringFunctions::replace_prepare', 'StringFunctions::replace_close'],
    [38230, 'split_part', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING', 'INT'],
     'StringFunctions::split_part_german_string'],
    [38240, 'instr', True, False, 'INT', ['GERMAN_STRING', 'GERMAN_STRING'], 'StringFunctions::instr_german_string'],
    [38250, 'concat', True, True, 'GERMAN_STRING', ['GERMAN_STRING', '...'],
     'StringFunctions::concat_german_string',
     'StringFunctions::concat_prepare', 'StringFunctions::concat_close'],
    [38260, 'locate', True, False, 'INT', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::locate_german_string'],
    [38261, 'locate', True, False, 'INT', ['GERMAN_STRING', 'GERMAN_STRING', 'INT'],
     'StringFunctions::locate_pos_german_string'],
    # ---- TYPE_GERMAN_STRING overloads for string builtins (batch c). ----
    [38270, 'starts_with', True, False, 'BOOLEAN', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::starts_with_german_string'],
    [38280, 'ends_with', True, False, 'BOOLEAN', ['GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::ends_with_german_string'],
    [38290, 'regexp_extract', True, False, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING', 'BIGINT'],
     'StringFunctions::regexp_extract_german_string',
     'StringFunctions::regexp_extract_prepare', 'StringFunctions::regexp_close'],
    [38300, 'regexp_replace', True, True, 'GERMAN_STRING', ['GERMAN_STRING', 'GERMAN_STRING', 'GERMAN_STRING'],
     'StringFunctions::regexp_replace_german_string',
     'StringFunctions::regexp_replace_prepare', 'StringFunctions::regexp_close'],
    [38310, 'LIKE', True, False, 'BOOLEAN', ['GERMAN_STRING', 'GERMAN_STRING'],
     'LikePredicate::like_german_string',
     'LikePredicate::like_prepare', 'LikePredicate::like_close'],
    [38311, 'REGEXP', True, False, 'BOOLEAN', ['GERMAN_STRING', 'GERMAN_STRING'],
     'LikePredicate::regex_german_string',
    ...
    [170008, 'map_entries', True, False, 'ANY_ARRAY', ['ANY_MAP'], 'MapFunctions::map_entries'],
