...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_SAHA_AGG_HASH_MAP = "enable_saha_agg_hash_map";
    ...
    @VarAttr(name = ENABLE_SAHA_AGG_HASH_MAP)
    private boolean enableSahaAggHashMap = false;
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setEnable_saha_agg_hash_map(enableSahaAggHashMap);
