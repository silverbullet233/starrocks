...
public class TypeCompatibilityMatrix {
    private static final List<PrimitiveType> SKIP_COMPARE_TYPES = Arrays.asList(
            ...
            // GERMAN_STRING is a query-path rewrite target; it never appears in DDL
            // nor in analyzer-resolved assignment compatibility, so skip matrix entries.
            PrimitiveType.GERMAN_STRING);
