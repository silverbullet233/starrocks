...
public class TypeDeserializer {
    ...
    public static PrimitiveType fromThrift(TPrimitiveType tPrimitiveType) {
        return switch (tPrimitiveType) {
            ...
            case STRING_V2 -> PrimitiveType.STRING_V2;
    ...
    private static Type scalarTypeFromThrift(TTypeNode node) {
        ...
        } else if (scalarType.getType() == TPrimitiveType.STRING_V2) {
            return TypeFactory.createStringV2Type(scalarType.isSetLen() ? scalarType.getLen() : 65533);
    ...
    public static ScalarType createType(PScalarType ptype) {
        ...
        switch (tPrimitiveType) {
            ...
            case STRING_V2:
                return TypeFactory.createStringV2Type(ptype.len != null ? ptype.len : 65533);
            case DECIMALV2:
