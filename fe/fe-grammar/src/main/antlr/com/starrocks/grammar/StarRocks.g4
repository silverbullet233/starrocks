...
showCreateRoutineLoadStatement
    : SHOW CREATE ROUTINE LOAD (db=qualifiedName '.')? name=identifier showPredicateClauses
    ;
...
nonReserved
    ...
    | STORAGE| STRING | STRING_AGG | STRING_V2 | STRUCT | STATS | SUBMIT | SUSPEND | SYNC | SYSTEM | SYSTEM_TIME
