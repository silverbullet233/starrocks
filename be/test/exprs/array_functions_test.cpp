...
TEST_F(ArrayFunctionsTest, array_length) {
    ...
    // [1, 2]
    {
        MutableColumnPtr c = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
    ...
    // ["a", "b"]
    {
        MutableColumnPtr c = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
        c->append_datum(Datum(DatumArray{}));
        c->append_datum(Datum());
        c->append_datum(Datum(DatumArray{Datum()}));
    ...
    // [[1], [2], [3]]
    {
        MutableColumnPtr c = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, true);
        c->append_datum(Datum(DatumArray{}));
        c->append_datum(Datum());
        c->append_datum(Datum(DatumArray{Datum()}));
    ...
    // [] only null
    {
        MutableColumnPtr c = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, true, true, 10);
    ...
    // [] only const
    {
        MutableColumnPtr src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
...
TEST_F(ArrayFunctionsTest, array_cum_sum) {
    ...
    // [null,null,1, null]
    {
        MutableColumnPtr c = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, true);
        c->append_datum(Datum(DatumArray{}));
        c->append_datum(Datum());
        c->append_datum(Datum(DatumArray{Datum()}));
    ...
    // [] only const
    {
        MutableColumnPtr src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, true);
...
TEST_F(ArrayFunctionsTest, array_contains_empty_array) {
    // array_contains([], 1)
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, false);
        array->append_datum(Datum(DatumArray{}));

        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), false, true, 0);
    ...
    // array_contains([], "abc")
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
        array->append_datum(Datum(DatumArray{}));

        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_VARCHAR), false, true, 0);
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, false);
        array->append_datum(Datum(DatumArray{}));

        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_ARRAY_INT), false);
    ...
    //  array_contains([], 3);
    {
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
        target->append_datum(Datum((int32_t)1));
    ...
    //  array_contains([], NULL);
    {
        ...
        array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        ...
        array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_contains_no_null) {
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_BOOLEAN), false);
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, false);
        array->append_datum(Datum(DatumArray{}));
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
        target->append_datum(Datum(DatumArray{}));
        target->append_datum(Datum(DatumArray{}));
        target->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_contains_has_null_target) {
    // array_contains(["abc", "def"], NULL)
    {
        ...
        // const-null column.
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_VARCHAR), true, true, 0);
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, false);
        array->append_datum(DatumArray{(int8_t)1, (int8_t)2, (int8_t)3});
        array->append_datum(DatumArray{(int8_t)1, (int8_t)2, (int8_t)3});
        array->append_datum(DatumArray{(int8_t)1, (int8_t)2, (int8_t)3});

        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_TINYINT), true);
...
TEST_F(ArrayFunctionsTest, array_contains_has_null_element_and_target) {
    ...
    // array_contains([[1,2], NULL], NULL)
    {
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_ARRAY_INT), true);
        target->append_datum(Datum());
        target->append_datum(Datum());
...
TEST_F(ArrayFunctionsTest, array_contains_nullable_array) {
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
    ...
    // array_contains([["a", "b"], ["c"]], ["c"])
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, true);
        array->append_datum(DatumArray{DatumArray{"a"}, DatumArray{"b"}});
        array->append_datum(Datum());
        array->append_datum(DatumArray{DatumArray{"a", "b"}, DatumArray{"c"}});

        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_ARRAY_VARCHAR), false);
    ...
    // array_contains(NULL, [NULL])
    {
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_ARRAY_VARCHAR), true);
        target->append_datum(Datum());
...
TEST_F(ArrayFunctionsTest, array_contains_all) {
    ...
    // array_contains_all(["a", "b", "c"], ["a", "c"])    -> 1
    {
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
        target->append_datum(DatumArray{"c"});
        target->append_datum(DatumArray{"c"});
        target->append_datum(Datum());
        target->append_datum(Datum());
    ...
    // array_contains_all([["a", "b"], ["c"], NULL], [["a", "b"], NULL])
    {
        ...
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, false);
...
TEST_F(ArrayFunctionsTest, array_position_has_null_element_and_target) {
    ...
    // array_position([NULL, "abc"], NULL): 1
    {
        ...
        // const-null column.
        MutableColumnPtr target = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_VARCHAR), true, true, 1);
...
TEST_F(ArrayFunctionsTest, array_append) {
    {
        ...
        MutableColumnPtr null = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_VARCHAR), true, true, 0);
    ...
    // array_append(NULL, 'def')
    {
        ...
        MutableColumnPtr data = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_VARCHAR), false, true, 0);
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, true);
        array->append_datum(Datum(DatumArray{}));
        ...
        MutableColumnPtr data = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, array_sum_empty_array) {
...

    {
        ...
        array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_avg_no_null) {
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_SMALLINT, false);
        array->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_sum_has_null_element) {
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, false);
        array->append_datum(Datum(DatumArray{}));
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_LARGEINT, false);
        array->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_min_has_null_element) {
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DATE, false);
        array->append_datum(Datum(DatumArray{}));
    ...
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DATETIME, false);
        array->append_datum(Datum(DatumArray{}));
...
TEST_F(ArrayFunctionsTest, array_sum_nullable_array) {
    {
        MutableColumnPtr array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, array_all_null) {
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(DatumArray{Datum()});
    ...
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
        array->append_datum(Datum(DatumArray{}));
        array->append_datum(DatumArray{Datum()});
        array->append_datum(DatumArray{Datum(), Datum(), Datum()});
        array->append_datum(DatumArray{Datum(), Datum(), Datum()});
...
TEST_F(ArrayFunctionsTest, array_reverse_int) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, array_reverse_string) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
...
TEST_F(ArrayFunctionsTest, array_difference_boolean) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, true);
...
TEST_F(ArrayFunctionsTest, array_difference_bigint) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, true);
...
TEST_F(ArrayFunctionsTest, array_difference_double) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, true);
...
TEST_F(ArrayFunctionsTest, array_slice_float) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_FLOAT, true);
...
TEST_F(ArrayFunctionsTest, array_concat_tinyint) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, true);
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, true);
    ...
    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, true);
...
TEST_F(ArrayFunctionsTest, array_concat_tinyint_not_nullable) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, false);
    src_column->append_datum(DatumArray{(int8_t)5, (int8_t)3, (int8_t)6});
    src_column->append_datum(DatumArray{(int8_t)8});
    src_column->append_datum(DatumArray{(int8_t)4});
    src_column->append_datum(DatumArray{(int8_t)4, (int8_t)1});

    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, false);
    src_column2->append_datum(DatumArray{(int8_t)5, (int8_t)6});
    src_column2->append_datum(DatumArray{(int8_t)2});
    src_column2->append_datum(DatumArray{(int8_t)4, (int8_t)3, (int8_t)2, (int8_t)1});
    src_column2->append_datum(DatumArray{(int8_t)4, Datum()});

    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, false);
    src_column3->append_datum(DatumArray{(int8_t)5});
    src_column3->append_datum(DatumArray{(int8_t)2, (int8_t)8});
    src_column3->append_datum(DatumArray{(int8_t)2, (int8_t)1});
    src_column3->append_datum(DatumArray{(int8_t)4, Datum(), (int8_t)2, (int8_t)1});
...
TEST_F(ArrayFunctionsTest, array_concat_bigint) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, true);
    ...
    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, true);
...
TEST_F(ArrayFunctionsTest, array_concat_bigint_not_nullable) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, false);
    src_column->append_datum(DatumArray{(int64_t)5, (int64_t)3, (int64_t)6});
    src_column->append_datum(DatumArray{(int64_t)8});
    src_column->append_datum(DatumArray{(int64_t)4});
    src_column->append_datum(DatumArray{(int64_t)4, (int64_t)1});

    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, false);
    src_column2->append_datum(DatumArray{(int64_t)5, (int64_t)6});
    src_column2->append_datum(DatumArray{(int64_t)2});
    src_column2->append_datum(DatumArray{(int64_t)4, (int64_t)3, (int64_t)2, (int64_t)1});
    src_column2->append_datum(DatumArray{(int64_t)4, Datum()});

    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BIGINT, false);
    src_column3->append_datum(DatumArray{(int64_t)5});
    src_column3->append_datum(DatumArray{(int64_t)2, (int64_t)8});
    src_column3->append_datum(DatumArray{(int64_t)2, (int64_t)1});
    src_column3->append_datum(DatumArray{(int64_t)4, Datum(), (int64_t)2, (int64_t)1});
...
TEST_F(ArrayFunctionsTest, array_concat_double) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, true);
    ...
    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, true);
...
TEST_F(ArrayFunctionsTest, array_concat_double_not_nullable) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, false);
    src_column->append_datum(DatumArray{(double)5, (double)3, (double)6});
    src_column->append_datum(DatumArray{(double)8});
    src_column->append_datum(DatumArray{(double)4});
    src_column->append_datum(DatumArray{(double)4, (double)1});

    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, false);
    src_column2->append_datum(DatumArray{(double)5, (double)6});
    src_column2->append_datum(DatumArray{(double)2});
    src_column2->append_datum(DatumArray{(double)4, (double)3, (double)2, (double)1});
    src_column2->append_datum(DatumArray{(double)4, Datum()});

    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_DOUBLE, false);
    src_column3->append_datum(DatumArray{(double)5});
    src_column3->append_datum(DatumArray{(double)2, (double)8});
    src_column3->append_datum(DatumArray{(double)2, (double)1});
    src_column3->append_datum(DatumArray{(double)4, Datum(), (double)2, (double)1});
...
TEST_F(ArrayFunctionsTest, array_concat_varchar) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
    ...
    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
...
TEST_F(ArrayFunctionsTest, array_concat_varchar_not_nullable) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
    src_column->append_datum(DatumArray{Slice("5"), Slice("3"), Slice("6")});
    src_column->append_datum(DatumArray{Slice("8")});
    src_column->append_datum(DatumArray{Slice("4")});
    src_column->append_datum(DatumArray{Slice("4"), Slice("1")});

    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
    src_column2->append_datum(DatumArray{Slice("5"), Slice("6")});
    src_column2->append_datum(DatumArray{Slice("2")});
    src_column2->append_datum(DatumArray{Slice("4"), Slice("3"), Slice("2"), Slice("1")});
    src_column2->append_datum(DatumArray{Slice("4"), Datum()});

    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, false);
    src_column3->append_datum(DatumArray{Slice("5")});
    src_column3->append_datum(DatumArray{Slice("2"), Slice("8")});
    src_column3->append_datum(DatumArray{Slice("2"), Slice("1")});
    src_column3->append_datum(DatumArray{Slice("4"), Datum(), Slice("2"), Slice("1")});
...
TEST_F(ArrayFunctionsTest, array_intersect_int) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
    ...
    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, array_intersect_int_with_not_null) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, false);
    src_column->append_datum(DatumArray{(int32_t)(5), (int32_t)(3), (int32_t)(6)});
    src_column->append_datum(DatumArray{(int32_t)(8)});
    src_column->append_datum(DatumArray{(int32_t)(4), (int32_t)(1)});
    src_column->append_datum(DatumArray{(int32_t)(4), (int32_t)(22), Datum()});

    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, false);
    src_column2->append_datum(DatumArray{(int32_t)(5), (int32_t)(6)});
    src_column2->append_datum(DatumArray{(int32_t)(2)});
    src_column2->append_datum(DatumArray{(int32_t)(4), (int32_t)(3), (int32_t)(2), (int32_t)(1)});
    src_column2->append_datum(DatumArray{(int32_t)(4), Datum(), (int32_t)(22), (int32_t)(66)});

    auto src_column3 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, false);
    src_column3->append_datum(DatumArray{(int32_t)(5)});
    src_column3->append_datum(DatumArray{(int32_t)(2), (int32_t)(8)});
    src_column3->append_datum(DatumArray{(int32_t)(4), (int32_t)(1)});
...
TEST_F(ArrayFunctionsTest, array_filter_tinyint_with_nullable) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, true);
...
TEST_F(ArrayFunctionsTest, array_filter_tinyint) {
    ...
    auto src_column2 = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, false);
...
TEST_F(ArrayFunctionsTest, array_filter_with_onlynull) {
    ...
    auto src_column_nullable = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_TINYINT, true);
...
TEST_F(ArrayFunctionsTest, array_generate_with_integer_columns) {
    auto start_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
    auto stop_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
    auto step_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
...
TEST_F(ArrayFunctionsTest, array_generate_when_overflow) {
    auto start_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_TINYINT), true);
    auto stop_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_TINYINT), true);
    auto step_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_TINYINT), true);
...
TEST_F(ArrayFunctionsTest, array_match_not_null) {
    auto src_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_BOOLEAN, false);
    src_column->append_datum(DatumArray{(int8_t)1, (int8_t)1, (int8_t)0});
    src_column->append_datum(DatumArray{(int8_t)0});
    src_column->append_datum(DatumArray{(int8_t)1});
    src_column->append_datum(DatumArray{Datum()});
...
TEST_F(ArrayFunctionsTest, array_contains_seq) {
    ...
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
        array->append_datum(DatumArray{"a", "b", "c"});
        array->append_datum(Datum());
        array->append_datum(DatumArray{"a", "b", "c"});
        array->append_datum(DatumArray{"a", "b", Datum()});
        ...
        auto target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_VARCHAR, true);
        target->append_datum(DatumArray{"c"});
        target->append_datum(DatumArray{"c"});
        target->append_datum(Datum());
        target->append_datum(Datum());
    ...
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, false);
        array->append_datum(DatumArray{Datum(DatumArray{"a"}), Datum(DatumArray{"b"})});
        array->append_datum(DatumArray{Datum(DatumArray{"a", "c"})});
        array->append_datum(DatumArray{Datum(DatumArray{"a", "b"}), Datum(DatumArray{"c"})});

        auto target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, false);
        target->append_datum(DatumArray{Datum(DatumArray{"c"})});
        target->append_datum(DatumArray{Datum(DatumArray{"c"})});
    ...
    // array_contains_seq([["a", "b"], ["c"]], [["a", "b"]])
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, true);
    ...
    // array_contains_seq([["a", "b"], ["c"]], [["a", "b"]])
    {
        ...
        auto target = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_VARCHAR, true);
...
void array_repeat_test(const Datum& element_0, const Datum& element_1, const Datum& element_2,
                       const Datum& element_null) {
    {
        ...
        // The normal case
        {
            auto src_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(Type), false, false, 0);
        ...
        {
            auto src_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(Type), true, false, 0);
            src_column->append_datum(element_0);
            src_column->append_datum(element_1);
        ...
        // The case for testing ConstColumn
        {
            ...
            auto src_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(Type), false, true, 0);
...
TEST_F(ArrayFunctionsTest, array_repeat_array) {
    {
        ...
        // The case for testing ConstColumn
        {
            ...
            auto src_data_column = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, array_flatten_int) {
    ...
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_ARRAY_INT, true);
...
TEST_F(ArrayFunctionsTest, null_or_empty) {
    ...
    // null_or_empty([]): 1
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, true);
        array->append_nulls(1);
    ...
    {
        auto array = ColumnHelper::create_column(kAllocator, TYPE_ARRAY_INT, false);
        array->append_datum(DatumArray{{1, 2}});
        array->append_datum(DatumArray{});
...
TEST_F(ArrayFunctionsTest, array_generate_date_with_year_unit) {
    ...
    auto start_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_DATE), true);
    auto stop_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_DATE), true);
    auto step_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
...
TEST_F(ArrayFunctionsTest, array_generate_datetime_with_hour_unit) {
    ...
    auto start_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_DATETIME), true);
    auto stop_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_DATETIME), true);
    auto step_column = ColumnHelper::create_column(kAllocator, TypeDescriptor(TYPE_INT), true);
