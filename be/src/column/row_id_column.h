...
public:
    ...
    size_t capacity() const override {
        return _be_ids->capacity();
    }
    size_t type_size() const override {
        return _be_ids->type_size() + _seg_ids->type_size() + _ord_ids->type_size();
    }
    size_t byte_size() const override {
        return _be_ids->byte_size() + _seg_ids->byte_size() + _ord_ids->byte_size();
    }
    ...
    size_t container_memory_usage() const override {
        return _be_ids->container_memory_usage() + _seg_ids->container_memory_usage() + _ord_ids->container_memory_usage();
    }
    ...
    // const StructColumn::Ptr& row_ids_column() const {
    //     return _row_ids;
    // }
    // StructColumn::Ptr& row_ids_column() {
    //     return _row_ids;
    // }
    const Columns columns() const {
        return Columns{_be_ids, _seg_ids, _ord_ids};
    }
    Columns columns() {
        return Columns{_be_ids, _seg_ids, _ord_ids};
    }

    const UInt32Column::Ptr& be_ids_column() const {
        return _be_ids;
    }
    UInt32Column::Ptr& be_ids_column() {
        return _be_ids;
    }
    const UInt32Column::Ptr& seg_ids_column() const {
        return _seg_ids;
    }
    UInt32Column::Ptr& seg_ids_column() {
        return _seg_ids;
    }
    const UInt32Column::Ptr& ord_ids_column() const {
        return _ord_ids;
    }
    UInt32Column::Ptr& ord_ids_column() {
        return _ord_ids;
    }
...
private:
    // use three UInt32Column to store be_id, seg_id and ord_id

    // @TODO we not null
    // StructColumn::Ptr _row_ids;
