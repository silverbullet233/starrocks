...
public:
    ...
    Status do_visit(const NullableColumn& column) {
        ...
        CompareVector null_vector(memory::get_default_allocator(), null_data.size());
        ...
        CompareVector cmp_vector(memory::get_default_allocator(), null_data.size());
        ...
        if (_rhs_value.is_null()) {
            ...
            CompareVector notnull_vector(memory::get_default_allocator(), null_data.size());
            for (size_t i = 0; i < null_data.size(); i++) {
