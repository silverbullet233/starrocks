...
#define APPLY_FOR_AGG_SET_VARIANT_ALL(M) \
    M(phase1_uint8)                      \
    M(phase1_int8)                       \
    M(phase1_int16)                      \
    M(phase1_int32)                      \
...
DEFINE_MAP_TYPE(AggHashMapVariant::Type::phase1_saha_string, SahaOneStringAggHashMap<PhmapSeed1>);
...
DEFINE_MAP_TYPE(AggHashMapVariant::Type::phase1_saha_null_string, SahaNullOneStringAggHashMap<PhmapSeed1>);
...
DEFINE_MAP_TYPE(AggHashMapVariant::Type::phase2_saha_string, SahaOneStringAggHashMap<PhmapSeed2>);
...
DEFINE_MAP_TYPE(AggHashMapVariant::Type::phase2_saha_null_string, SahaNullOneStringAggHashMap<PhmapSeed2>);
...
bool AggHashMapVariant::is_saha_string_type() const {
    return _type == Type::phase1_saha_string || _type == Type::phase1_saha_null_string ||
           _type == Type::phase2_saha_string || _type == Type::phase2_saha_null_string;
}
...
#define M(NAME)                                                                                                    \
    case Type::NAME:                                                                                               \
        hash_set_with_key = std::make_unique<detail::AggHashSetVariantTypeTraits<Type::NAME>::HashSetWithKeyType>( \
                state->chunk_size(), _agg_stat);                                                                   \
        break;
        APPLY_FOR_AGG_SET_VARIANT_ALL(M)
#undef M
    }
}
