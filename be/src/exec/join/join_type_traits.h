...
#define APPLY_JOIN_HASH_MAP_METHOD_UNARY_TYPE(M) \
    ...
    M(LINEAR_CHAINED_SET_STRING_V2)              \
                                                 \
    ...
    M(LINEAR_CHAINED_ASOF_STRING_V2)
...
REGISTER_JOIN_MAP_METHOD_TYPE(BUCKET_CHAINED, TYPE_STRING_V2, BucketChainedJoinHashMap, BUCKET_CHAINED_STRING_V2);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED, TYPE_STRING_V2, LinearChainedJoinHashMap, LINEAR_CHAINED_STRING_V2);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED_SET, TYPE_STRING_V2, LinearChainedJoinHashSet, LINEAR_CHAINED_SET_STRING_V2);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED_ASOF, TYPE_STRING_V2, LinearChainedAsofJoinHashMap,
                              LINEAR_CHAINED_ASOF_STRING_V2);
