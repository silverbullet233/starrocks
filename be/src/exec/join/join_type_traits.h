...
#define APPLY_JOIN_HASH_MAP_METHOD_UNARY_TYPE(M) \
    ...
    M(BUCKET_CHAINED_GERMAN_STRING)              \
                                                 \
    ...
    M(LINEAR_CHAINED_GERMAN_STRING)              \
                                                 \
    ...
    M(LINEAR_CHAINED_SET_GERMAN_STRING)          \
                                                 \
    ...
    M(LINEAR_CHAINED_ASOF_GERMAN_STRING)
...
REGISTER_KEY_CONSTRUCTOR(ONE_KEY, TYPE_GERMAN_STRING, KeyConstructorForOneKey<TYPE_GERMAN_STRING>, ONE_KEY_GERMAN_STRING);
...
REGISTER_JOIN_MAP_METHOD_TYPE(BUCKET_CHAINED, TYPE_GERMAN_STRING, BucketChainedJoinHashMap,
                              BUCKET_CHAINED_GERMAN_STRING);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED, TYPE_GERMAN_STRING, LinearChainedJoinHashMap,
                              LINEAR_CHAINED_GERMAN_STRING);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED_SET, TYPE_GERMAN_STRING, LinearChainedJoinHashSet,
                              LINEAR_CHAINED_SET_GERMAN_STRING);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED_ASOF, TYPE_GERMAN_STRING, LinearChainedAsofJoinHashMap,
                              LINEAR_CHAINED_ASOF_GERMAN_STRING);
