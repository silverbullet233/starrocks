...
HyBirdBlockManager::HyBirdBlockManager(const TUniqueId& query_id, std::unique_ptr<BlockManager> local_block_manager, std::unique_ptr<BlockManager> remote_block_manager):
        _local_block_manager(std::move(local_block_manager)), _remote_block_manager(std::move(remote_block_manager)){}
