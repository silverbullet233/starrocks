...
private:
    ...
    void _copy_probe_rows_with_index_base_build(Column* dest_col, ColumnPtr& src_col, size_t start_row,
                                                size_t copy_number);
    void _copy_probe_rows_with_index_base_probe(Column* dest_col, ColumnPtr& src_col, size_t start_row,
                                                size_t copy_number);

    void _copy_build_rows_with_index_base_build(Column* dest_col, ColumnPtr& src_col, size_t start_row,
                                                size_t row_count);
    void _copy_build_rows_with_index_base_probe(Column* dest_col, ColumnPtr& src_col, size_t start_row,
                                                size_t row_count);
