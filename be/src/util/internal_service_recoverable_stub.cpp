...
void PInternalService_RecoverableStub::lookup(google::protobuf::RpcController* controller, const PLookUpRequest* request, PLookUpResponse *response, google::protobuf::Closure* done) {
    auto closure = new RecoverableClosure(shared_from_this(), controller, done);
