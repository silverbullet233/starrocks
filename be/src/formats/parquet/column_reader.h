...
class ColumnReader {
public:
    explicit ColumnReader(const ParquetField* parquet_field, memory::Allocator* allocator = nullptr)
            : _parquet_field(parquet_field), _allocator(allocator) {}
    virtual ~ColumnReader() = default;

    memory::Allocator* allocator() const {
        return _allocator != nullptr ? _allocator : memory::get_default_allocator();
    }
