...
StatusOr<ColumnPtr> BitFunctions::bitAnd(FunctionContext* context, const Columns& columns) {
    ...
    return VectorizedStrictBinaryFunction<bitAndImpl>::evaluate<Type>(context->get_allocator(), l, r);
}
...
StatusOr<ColumnPtr> BitFunctions::bitOr(FunctionContext* context, const Columns& columns) {
    auto& l = VECTORIZED_FN_ARGS(0);
    auto& r = VECTORIZED_FN_ARGS(1);
    return VectorizedStrictBinaryFunction<bitOrImpl>::evaluate<Type>(context->get_allocator(), l, r);
}
...
StatusOr<ColumnPtr> BitFunctions::bitXor(FunctionContext* context, const Columns& columns) {
    auto& l = VECTORIZED_FN_ARGS(0);
    auto& r = VECTORIZED_FN_ARGS(1);
    return VectorizedStrictBinaryFunction<bitXorImpl>::evaluate<Type>(context->get_allocator(), l, r);
}
...
StatusOr<ColumnPtr> BitFunctions::bitShiftLeft(FunctionContext* context, const Columns& columns) {
    auto& l = VECTORIZED_FN_ARGS(0);
    auto& r = VECTORIZED_FN_ARGS(1);
    return VectorizedStrictBinaryFunction<bitShiftLeftImpl>::evaluate<Type, TYPE_BIGINT, Type>(context->get_allocator(), l, r);
}
...
StatusOr<ColumnPtr> BitFunctions::bitShiftRight(FunctionContext* context, const Columns& columns) {
    auto& l = VECTORIZED_FN_ARGS(0);
    auto& r = VECTORIZED_FN_ARGS(1);
    return VectorizedStrictBinaryFunction<bitShiftRightImpl>::evaluate<Type, TYPE_BIGINT, Type>(context->get_allocator(), l, r);
}
...
StatusOr<ColumnPtr> BitFunctions::bitShiftRightLogical(FunctionContext* context, const Columns& columns) {
    auto& l = VECTORIZED_FN_ARGS(0);
    auto& r = VECTORIZED_FN_ARGS(1);
    return VectorizedStrictBinaryFunction<bitShiftRightLogicalImpl>::evaluate<Type, TYPE_BIGINT, Type>(context->get_allocator(), l, r);
}
template <LogicalType Type>
