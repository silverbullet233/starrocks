...
public:
    ...
    std::pair<Columns, UInt32Column::Ptr> process(RuntimeState* runtime_state,
        ...
        auto res_data_col = RunTimeColumnType<TYPE_BIGINT>::create(memory::get_default_allocator(), chunk_size);
        auto res_offset_col = UInt32Column::create(memory::get_default_allocator());
